import torch
from modeling.models.ET import base
from modules.dec_object import ObjectClassifier
from modules.enc_lang import EncoderLang
from modules.enc_visual import FeatureFlat
from modules.enc_vl import EncoderVL
from modules.encodings import DatasetLearnedEncoding
...
class Model(base.Model):
    ...
    def compute_batch_loss(self, model_out, gt_dict):
        ...
        action_gt = gt_dict["driver_action"].view(-1)
